...
export default function CustomerProfileScreen() {
  ...
  const onLogout = () => {
    Alert.alert('Выйти из аккаунта?', 'Потребуется снова войти по телефону.', [
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <View style={styles.hero}>
        ...
        <Text style={styles.name}>{greetingName(user)}</Text>
        <Text style={styles.phone}>{user.phone}</Text>
        {user.email ? <Text style={styles.email}>{user.email}</Text> : null}
        <View style={styles.rolePill}>
          <Text style={styles.rolePillText}>Клиент</Text>
        </View>
      </View>
      ...
      >
        ...
        <View style={styles.rowBody}>
          ...
          <Text style={styles.rowSub}>Условия, контакты, оплата</Text>
        </View>
