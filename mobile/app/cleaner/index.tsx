  ...
  return (
    <View style={styles.wrap}>
      <View style={styles.toolbar}>
        <Text style={styles.role}>Клинер · {user.phone}</Text>
      ...
      {error && (
        <Text style={styles.err}>Не удалось загрузить заказы. Проверьте API и сеть.</Text>
      )}
      <FlatList
        data={data ?? []}
        ...
        ListEmptyComponent={
          !isLoading && !error ? <Text style={styles.empty}>Нет назначенных заказов</Text> : null
        }
        renderItem={({ item }) => (
